...
`);
  ...
  var Rooms = {
    ...
    joinRoom: function(roomCode2, password, nickname2, photoId2) {
      console.log("Joining room: ", this.currentChannel, this.socket);
      if (this.currentChannel) {
        this.removeListeners();
        this.currentChannel.leave().receive("ok", () => console.log(`Left room: ${roomCode2}`)).receive("error", () => console.log(`Failed to leave room: ${roomCode2}`));
      }
      const channel = this.socket.channel(`room:${roomCode2}`, { password, nickname: nickname2, photo_id: photoId2 });
      ...
      document.getElementById("btn-create-room").addEventListener("click", () => {
        ...
        if (this.currentChannel) {
          this.currentChannel.push("create_room", {
            ...
            alert(
              `Room created with code: ${resp.room_code}`
            );
...
`;
  ...
  room_default.init(user_socket_default);
})();
/**
 * @license MIT
